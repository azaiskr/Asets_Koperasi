...
(2, 'Mobil', 'Sekaran', 'Jelek', 5, 20, 30000000),
...
('P0003', 'Gergaji', 3, '2023-04-26', 'Belum Lunas');
...
(35, 'kuriyK', 'kuriyamam751@gmail.com', NULL, '$2y$10$9/HUwzIBhvxU5djAWXTgGOrP9sinA1BPJ1f5.oVNhszMYZF.UqJtm', NULL, '2023-05-03 09:20:34', '2023-05-03 09:21:32', 1, 'JsBrL8vfR1xhWDwAKNcW4a8wO2zW46bXe0Y69JpegMQBrf60rT1H04SCc8DEnLke');
...
--
ALTER TABLE `aset_pengalihan`
  MODIFY `id_Aset` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `aset_tetaps`
--
ALTER TABLE `aset_tetaps`
  MODIFY `id_Aset` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
