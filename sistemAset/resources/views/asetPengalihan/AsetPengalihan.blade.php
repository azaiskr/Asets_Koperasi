        ...
        <div>
            <table class="table-div">
                <thead class="thead-primary">
                    <tr>
                        <th class="text-center">ID Pengalihan</th>
                ...
                @foreach($aset_pengalihan as $ap)
                    <tr>
                        <td class="text-center">{{ $ap->id_Aset_Pengalihan }}</td>
						...
						<td>
                            <a class="btnEdit" href="/AsetPengalihan/edit/{{$ap->id_Aset_Pengalihan}}">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <a class="btnRemove" href="/AsetPengalihan/hapus/{{$ap->id_Aset_Pengalihan}}"> 
